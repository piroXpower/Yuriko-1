...
from .helper_funcs.blaze import user_admin, AdminPerms
from .helper_funcs.chat_status import bot_admin, connection_status, user_admin_no_reply
from .helper_funcs.decorators import emikocmd, emikocallback
...
@emikocmd(command="raid", pass_args=True)
@bot_admin
@connection_status
@loggable
...
@emikocallback(pattern="enable_raid=")
@connection_status
@user_admin_no_reply
@loggable
...
@emikocallback(pattern="disable_raid=")
@connection_status
@user_admin_no_reply
@loggable
...
@emikocallback(pattern="cancel_raid=")
@connection_status
@user_admin_no_reply
...
@emikocmd(command="raidactiontime", pass_args=True)
@connection_status
@user_admin(AdminPerms.CAN_CHANGE_INFO)
@loggable
def raidtime(update: Update, context: CallbackContext) -> Optional[str]:
